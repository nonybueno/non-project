...
const image = ref( '/images/D3-Pan-145.jpg')

function changeImage(imageNumber) {
            if (imageNumber === 'next') {
                image.value = '/images/D3-Pan-145.jpg';
            } else if (imageNumber === 'back') {
                image.value = '/images/pic1.jpg';
            } else if (imageNumber === 3) {
                image.value = '/images/pic11.jpg';
            }
        }
...
<template>
            ...
            <div class="w-5/6 h-full">
                ...
                <div class="mt-5 flex justify-center items-center">
                    <div class="h-10 grid grid-cols-3 gap-16">
                        <div class="text-[#34623F] flex justify-center items-center p-1 tracking-widest"><router-link to="/about">About</router-link></div>
                        <!-- <div class="text-[#34623F] flex justify-center items-center p-1 tracking-widest"><router-link to="/resume">Resume</router-link></div> -->
                        <div class="text-white flex justify-center items-center p-1 tracking-widest hover:cursor-default bg-[#34623F] rounded-full">myWeb</div>
                        ...
                        <div class="text-[#34623F] flex justify-center items-center p-1 tracking-widest"><router-link to="/contact">Contact</router-link></div>
                    </div>
                </div>
                <div v-motion-slide-right v-motion-slide-visible-right class="text-white flex text-7xl max-sm:text-4xl items-center max-sm:mt-10 mt-24 ml-20 max-sm:ml-0 tracking-wider">
                    Hi,I'm<span class="font-bold ml-5 max-sm:ml-3 text-[#34623F]">{{ displayedText }}</span>
                </div>
                ...
                <div class=" ml-20 h-24 w-full flex items-center gap-8 max-sm:ml-0 max-sm:justify-center">
                    <a href="https://www.facebook.com/lnw.non.1" target="_blank" class="hover:scale-125 h-12 rounded-full bg-[#1F413B] w-12 max-sm:h-10 max-sm:w-10"><img src="../../public/images/facebook.png" alt="facebook" class="rounded-full p-1"></a>
                    <a href="https://www.instagram.com/nonchyy_/" target="_blank" class="hover:scale-125 h-12 rounded-full bg-[#1F413B] w-12 max-sm:h-10 max-sm:w-10"><img src="../../public/images/ig.png" alt="ig" class="rounded-full p-2"></a>
                    <a href="https://github.com/nonybueno" target="_blank" class="hover:scale-125 h-12 rounded-full bg-[#1F413B] w-12 max-sm:h-10 max-sm:w-10"><img src="../../public/images/github.png" alt="github" class="rounded-full p-1.5"></a>
                    <a href="mailto:thaninpong.non@mail.kmutt.ac.th" target="_blank" class="hover:scale-125 h-12 rounded-full bg-[#1F413B] w-12 max-sm:h-10 max-sm:w-10"><img src="../../public/images/email.png" alt="email" class="rounded-full"></a>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-center ">
            ...
            <div class="h-[15cm] max-sm:h-[7cm] max-sm:pl-2 relative pl-8 bg-[#2F6859]" v-motion-fade-visible v-motion-fade>
                <div class="h-[16cm] border-[0.15cm] max-sm:h-[8cm] border-white max-sm:w-3/6 w-1/3 absolute bottom-9 max-sm:bottom-3">
                    <img src="../../public/images/D3-Pan-481.jpg" alt="myPic" class="h-full">
                </div>
                <div class=" w-full h-full grid grid-cols-3">
                    <div class="col-start-2 col-span-2 h-full max-sm:ml-2">
                        <div class="ml-10 h-full text-white max-sm:ml-16">
                            <div class="mt-10 max-sm:mt-2 mb-6 text-7xl font-bold max-sm:text-2xl max-sm:mb-2" v-motion-slide-left v-motion-slide-visible-left>Transforming Ideas Into Functional Websites.</div>
                            ...
                            <div class="flex items-center mt-24 max-sm:mt-5 max-sm:text-xs">
                                <div class="rounded-md h-10 w-32 max-sm:h-7 max-sm:w-20 bg-white text-[#1F413B] flex justify-center items-center cursor-pointer hover:scale-110">
                                    <a href="../../public/resume/Thaninpongs_Resume.pdf" download>
                                ...
                                <div class="ml-10 max-sm:ml-3 underline tracking-wider font-bold"><router-link to="/contact">Contact</router-link></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" mt-10 max-sm:mt-4">
                <div class="h-10 grid grid-cols-4 max-sm:grid-cols-6 max-sm:h-8">
                    <div class="col-span-3 max-sm:col-span-4 text-xl max-sm:text-sm tracking-wider font-bold text-[#1F413B]">MY SKILLSET <span class="text-[#2F6859]">(hard skill)</span><span class="ml-20 max-sm:ml-5">></span></div>
                    ...
                    <div class="border h-full bg-[#1F413B] rounded-xl">
                        ...
                        <div class="grid grid-cols-2 bg-white mx-5 max-sm:mx-2 max-sm:mb-2 rounded-lg">
                            <div class="flex justify-center mt-5">
                                <img src="../../public/images/image_18.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center mt-5">
                                <img src="../../public/images/image_19.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center my-5">
                                <img src="../../public/images/image_20.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center my-5">
                                <img src="../../public/images/image_21.png" class="h-20 max-sm:h-14">
                            </div>
                        </div>
                    </div>
                    <div class="border h-full bg-[#1F413B] rounded-xl">
                        ...
                        <div class="grid grid-cols-1  bg-white mx-5 max-sm:mx-2 max-sm:mb-2 rounded-lg">
                            <div class="flex justify-center mt-5">
                                <img src="../../public/images/image_22.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center my-5">
                                <img src="../../public/images/image_23.png" class="h-20 max-sm:h-14">
                            </div>
                        </div>
                    </div>
                    <div class="border h-full bg-[#1F413B] rounded-xl">
                        ...
                        <div class="grid grid-cols-1  bg-white mx-5 max-sm:mx-2 max-sm:mb-2 rounded-lg">
                            <div class="flex justify-center mt-5">
                                <img src="../../public/images/image_28.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center my-5">
                                <img src="../../public/images/oracle.png" class="h-20 max-sm:h-14">
                            </div>
                        </div>
                    </div>
                    <div class="border h-full bg-[#1F413B] rounded-xl">
                        ...
                        <div class="grid grid-cols-1  bg-white mx-5 max-sm:mx-2 max-sm:mb-2 rounded-lg">
                            <div class="flex justify-center mt-5">
                                <img src="../../public/images/image_25.png" class="h-20 max-sm:h-14">
                            </div>
                            <div class="flex justify-center my-5">
                                <img src="../../public/images/image_26.png" class="h-20 max-sm:h-14">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-[#2F6859] flex justify-center mt-10 h-full max-sm:mt-96">
        <div class="w-5/6 max-sm:w-11/12">
            <div class="text-xl tracking-wider font-bold text-white mt-7 max-sm:mt-4 max-sm:text-sm">MY ACTIVITIES&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></div>
        ...
        <div class="grid grid-cols-2 mt-5 gap-5 max-sm:mt-3 max-sm:gap-2">
            <div class="text-white">
                <div class="h-[28rem] max-sm:h-[16rem] bg-white m-3 max-sm:m-0" v-motion-fade-visible v-motion-fade>
                    <img src="../../public/images/D10-SIX-202.JPG" alt="group" class="h-full w-full max-sm:h-full">
                </div>
                <div class="text-xl max-sm:text-xs tracking-widest mt-8 max-sm:mt-3 flex items-center max-sm:grid max-sm:grid-cols-9">
                    <img src="../../public/images/ig.png" alt="ig" class="h-10 w-10 mr-5 max-sm:mr-0.5 max-sm:h-5 max-sm:w-5">
                ...
                <div class="text-xl max-sm:text-xs tracking-widest my-5 flex items-center max-sm:my-4 max-sm:grid max-sm:grid-cols-9">
                    <img src="../../public/images/facebook.png" alt="facebook" class="h-10 w-10 mr-5 max-sm:mr-0.5 max-sm:h-5 max-sm:w-5">
                ...
                <div class="grid grid-cols-3 gap-5 ml-10 max-sm:ml-1 max-sm:gap-0.5">
                    ...
                    <div class="max-sm:h-12 max-sm:w-12 h-24 rounded-full w-24 bg-[url('/images/Neptune-bg.png')]">
                        <img src="../../public/images/Neptune.PNG" class="">
                    </div>
                </div>
            </div>
            <div class=" text-white">
                <div class="text-4xl max-sm:text-lg font-semibold tracking-wider"><span class="text-7xl max-sm:text-xl font-bold">IT</span>#29 STARTER PACK</div>
                ...
                <div class="ml-5 max-sm:ml-2">
                    ...
                    <div class="text-xl tracking-wide max-sm:text-xs my-10 max-sm:my-2">
                        <ul class="list-disc">
                            <li>My duties in the academic part are to control the content teaching, supervise the teaching of staff, and support staff and learner in the classroom.</li> 
                        </ul>
                    </div>
                    <div class="text-xl tracking-wide max-sm:text-xs">
                        <ul class="list-disc">
                ...
                <div class="grid grid-cols-3 gap-3 mt-10 mb-5 max-sm:mt-3" v-motion-fade-visible v-motion-fade>
                    <div>
                        <img src="../../public//images/D3-Pan-149.jpg" alt="myPic" class="h-60 w-full max-sm:h-20">
                    </div>
                    <div>
                        <img src="../../public//images/D3-Pan-162.jpg" alt="myPic" class="h-60 w-full max-sm:h-20">
                    </div>
                    <div>
                        <img src="../../public//images/D3-Pan-171.jpg" alt="myPic" class="h-60 w-full max-sm:h-20">
                    </div>
                </div>
            </div>
     ...
     <div class=" flex justify-center h-full text-[#34623F]">
        <div class="w-5/6 max-sm:w-11/12">
        <div class="grid grid-cols-2  w-full mt-5 gap-5 mb-10 max-sm:mb-5">
            
            <div class="">
                <div class="text-4xl font-semibold tracking-wider max-sm:text-lg"><span class="text-7xl max-sm:text-xl font-bold">Hello</span>&nbsp;#WORLD FENNEC</div>
                <div class="border-b-2 mx-5 mt-2 mb-10 max-sm:mb-3"></div>
                ...
                <div class="grid grid-cols-3 gap-3 mt-16 mb-5 max-sm:mt-3" v-motion-fade-visible v-motion-fade>
                    <div class="">
                        <img src="../../public//images/IMG_3878.jpg" alt="myPic" class="h-60 w-full max-sm:h-20">
                    </div>
                    <div class="">
                        <img src="../../public//images/IMG_3885.jpg" alt="myPic" class="h-60 max-sm:h-20">
                    </div>
                    <div class="">
                        <img src="../../public//images/IMG_3889.jpg" alt="myPic" class="h-60 w-full max-sm:h-20">
                    </div>
                </div>
            </div>
            <div class="">
                <div class="h-[28rem] max-sm:h-[15rem] max-md:m-0 bg-gray-400 m-3" v-motion-fade-visible v-motion-fade>
                    <img src="../../public/images/pic11.jpg" alt="group" class="h-full">
                </div>
                <div class="text-xl max-sm:text-xs tracking-widest mt-8 max-sm:mt-3 flex items-center max-sm:grid max-sm:grid-cols-9">
                    <img src="../../public/images/ig.png" alt="ig" class="h-10 w-10 mr-5 max-sm:mr-0.5 max-sm:h-5 max-sm:w-5">
                    <span class="max-sm:col-start-2 font-bold">IG:</span>
                ...
                <div class="grid grid-cols-3 gap-5 ml-10 max-sm:ml-0 max-sm:gap-0.5">
                    <div class="max-sm:h-12 max-sm:w-12 h-24 rounded-full w-24 bg-white">
                        <img src="../../public/images/f1.png" class="">
                    </div>
                    <div class="max-sm:h-12 max-sm:w-12 h-24 rounded-full w-24">
                        <img src="../../public/images/f2.png" class="">
                    </div>
                    <div class="max-sm:h-12 max-sm:w-12 h-24 rounded-full w-24">
                        <img src="../../public/images/f3.png" class="">
                    </div>
                </div> 
            </div>
        </div>
        ...
        <div class="h-10 grid grid-cols-4 max-sm:grid-cols-6 max-sm:h-5">
            <div class="col-span-3 text-xl max-sm:text-sm tracking-wider font-bold text-[#1F413B]">MY PROJECT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;></div>
            <div class="col-start-4 text-xl max-sm:flex max-sm:justify-end max-sm:col-span-3 max-sm:text-sm tracking-wider text-[#1F413B]">group team <span class="font-bold max-sm:ml-0.5">Project</span></div>
        </div>
        <div class="grid grid-cols-4 gap-5 h-80 mt-8 max-sm:mt-4 max-sm:grid-cols-2">
                <div class="h-full w-full border p-3 rounded-xl bg-[#1F413B]">
                    <div class="h-4/5 border w-full rounded-lg bg-gray-300">
                        <img src="../../public/images/Neptune.PNG" class="h-full w-full">
                    </div>
                    <div class=" grid grid-cols-2 gap-3 h-10 mt-4 max-sm:h-8 max-sm:mt-2">
                        ...
                        <div class="flex justify-center items-center border rounded-sm cursor-pointer hover:scale-105 bg-white">MORE</div>
                    </div>
                </div>
            <div class="h-full w-full border p-3 rounded-xl bg-[#1F413B]">
                <div class="h-4/5 border w-full rounded-lg bg-gray-300">
        ...
        <div class="grid grid-cols-4 my-5 gap-5 max-sm:hidden">
            <div class="text-xl text-[#34623F] pl-2">Word Typing Test Website
                <div class="text-sm text-gray-400">INT-203 Client-side</div>
            </div>
            <div class="text-xl text-[#34623F] pl-2">E-Book Online Bookstore
                <div class="text-sm text-gray-400">INT-203 Client-side</div>
            </div>
            <div class="text-xl text-[#34623F] pl-2">SIT-Announcement System
    ...
    <div class="max-sm:hidden">
        ...
        <div class="w-screen bg-[#2F6859] h-96 flex">
            ...
            <div class="ml-5 mt-3 text-white w-2/4">
                ...
                <div class="text-xl mt-3">Website: <a href="https://alumilizeType.com" class="underline-offset-1 underline" target="_blank">https://alumilizeType.com</a></div>
                <div class="flex justify-end">
                    <div class="cursor-pointer rounded-xl bg-white text-[#2F6859] w-24 flex justify-center h-8 items-center text-md mt-3 hover:scale-110">Website</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-screen bg-[#2F6859] h-96 flex">
            ...
            <div class="ml-5 text-white w-2/4 mt-1">
                ...
                <div class="text-xl mt-2">Website: <a href="https://alumilizeType.com" class="underline-offset-1 underline" target="_blank">https://alumilizeType.com</a></div>
                <div class="flex justify-end">
                    <div class="cursor-pointer rounded-xl bg-white text-[#2F6859] w-24 flex justify-center h-8 items-center text-md mt-2 hover:scale-110">Website</div>
                </div>
            </div>
        </div>
        ...
        <div class="w-screen bg-[#2F6859] h-96 flex">
            <div class="w-2/5 h-full">
                <div class="h-full w-fit" >
                    <img id="mainImage" :src="image" class="h-full">
                </div>

                <div>
                    <button @click="changeImage('back')" class="border rounded-full h-14 w-14">back</button>
                    <button @click="changeImage('next')" class="border rounded-full h-14 w-14">next</button>
                </div>
            </div>
            <div class="ml-5 max-sm:ml-0 text-white w-2/4 mt-1">
                ...
                <div class="text-xl mt-2">Repository: <a href="https://github.com/nonybueno/PROJECT-BNW" class="underline-offset-1 underline" target="_blank">https://github.com/nonybueno/PROJECT-BNW</a></div>
                <div class="text-xl mt-2">Website: <a href="https://www.figma.com/file/M35yOfYD32UABPsZNHPNFN/Untitled?type=design&node-id=0%3A1&mode=design&t=tI3cd8oynDOCE8dM-1" class="underline-offset-1 underline" target="_blank">https://www.figma.com/file/M35yOfYD32UABPsZNHPNFN/Untitled?type=design&node-id=0%3A1&mode=design&t=tI3cd8oynDOCE8dM-1</a></div>
